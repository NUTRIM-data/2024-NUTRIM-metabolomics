...
The raw MS data consists of chromatograms showing peaks of intensity of detected metabolites over time (see figure below @fig-tic), mass spectrum and retention time.


![Total Ion Chromatogram](images/TIC.png){fig-align="center" #fig-tic}
...
TODO: explain TAN here: For each sample, every metabolite intensity value is vivided divided by the total sum of all metabolite intensity values measured in that sample (\code{NA} values ignored by default), before multiplication by 100. The unit is %.
...
-   TODO: Click here: [https://david-barnett.github.io/2024-NUTRIM-microbiome/practical-2/web/practical2-instructions.html](...)
